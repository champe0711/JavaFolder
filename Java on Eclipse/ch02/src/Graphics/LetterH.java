...
//    public LetterH(int x, int y, Color col, double size) {
//        xLeft = x;
//        yTop = y;
//        c = col;
////        tx = size;
//    }
    ...
    public LetterH(int x, int y, Color col) {
        xLeft = x;
        yTop = y;
        c = col;
//        tx = size;
    ...
    public void draw(Graphics2D g2) {
        ...
        Line2D.Double MiddleBar = new Line2D.Double(p3, p4);
        Line2D.Double RightBar = new Line2D.Double(p5, p6);
